    ...
    data: {
      ...
      messages: {
        create: [
          ...
          {
            content: 'Welcome to ChargedUp AI! I\'m here to help you with marketing strategies, content creation, and business insights. What would you like to explore today?',
            role: 'ASSISTANT',
          },
        ],
      },
