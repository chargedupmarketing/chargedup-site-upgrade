  ...
  const steps = [
    {
      ...
      title: 'Audit & Analyze',
      description:
        'We dive deep into your current marketing to find opportunities.',
      detailedInfo:
        'Our comprehensive marketing audit examines your current strategies, audience insights, conversion funnels, and competitive landscape. We identify gaps, opportunities, and areas for optimization to create a solid foundation for growth.',
    },
    {
      id: 2,
      title: 'Strategize',
      ...
      detailedInfo:
        'Using advanced AI tools and data-driven insights, we develop a customized marketing strategy tailored to your business goals. This includes audience targeting, channel selection, content planning, and performance metrics that align with your growth objectives.',
    },
    {
      id: 3,
      title: 'Execute',
      ...
      detailedInfo:
        'Our expert team implements your strategy across all selected channels, continuously monitoring performance and making real-time adjustments. We handle everything from content creation to campaign management, ensuring optimal results.',
    },
    {
      id: 4,
      ...
      detailedInfo:
        'We provide detailed analytics and insights, showing you exactly how your campaigns are performing. Our team continuously optimizes based on data, improving ROI and scaling successful strategies while maintaining transparency.',
    },
  ];
    ...
    <div className="relative overflow-hidden">
            ...
            <div className="space-y-6 hero-text">
              <div className="relative">
                ...
                <h1 className="h1 relative z-10">
                  ...
                  <span className="text-[#fcb80a]">Charged‑Up</span> ⚡
                </h1>
              </div>
              ...
              <div className="relative min-h-[80px]">
                ...
                <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/30 border border-white/20 rounded-xl p-6 transition-all duration-500 ease-in-out">
                  ...
                  {slides[currentSlide].subtitle && (
                    <p className="p text-lg font-semibold text-orange-400 mt-2">
                      {slides[currentSlide].subtitle}
                    </p>
                  )}
                </div>
              ...
              <div className="flex gap-3">
                <Link href={slides[currentSlide].href} className="btn-primary">
                  {slides[currentSlide].button}
                </Link>
                <Link href="/pricing#ai-pricing" className="btn-outline">
                  See Pricing
                </Link>
              </div>
              ...
              <div className="mt-6 relative min-h-[60px]">
                  ...
                  <ul className="text-white/60 text-sm grid grid-cols-3 gap-4 pt-4">
                    <li>
                      <strong className="text-white">
                        <LightningBoltIcon className="inline h-4 w-4" /> 14d
                      </strong>{' '}
                      to launch
                    </li>
                    <li>
                      <strong className="text-white">30–60%</strong> ops time
                      saved
                    </li>
                    <li>
                      <strong className="text-white">3–6x</strong> ROAS targets
                    </li>
                  </ul>
                </div>
                ...
                >
                  <ul className="text-white/60 text-sm grid grid-cols-3 gap-4 pt-4">
                    <li>
                      <strong className="text-white">AI</strong> Agent
                    </li>
                    <li>
                      <strong className="text-white">AI</strong> Lead Capture
                    </li>
                    <li>
                      <strong className="text-white">Multi</strong>-Platform
                    </li>
                  </ul>
                </div>
                ...
                >
                  <ul className="text-white/60 text-sm grid grid-cols-3 gap-4 pt-4">
                    <li>
                      <strong className="text-white">AI</strong> Strategy
                    </li>
                    <li>
                      <strong className="text-white">Content</strong> Automation
                    </li>
                    <li>
      ...
      <section className="pt-6 pb-8 md:pt-8 md:pb-12 relative z-10 bg-gradient-to-br from-[color:var(--brand-primary,#fc5f17)] to-orange-500">
        <div className="container">
          <FadeIn delay={200}>
            <h2 className="text-white text-center mb-6 text-2xl md:text-4xl font-semibold tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 relative">
            ...
            {steps.map((step, index) => (
              <FadeIn key={step.id} delay={400 + index * 100}>
                ...
                >
                  <div className="text-2xl font-bold text-[#e55a15] mb-2">
                    {step.id}
                  </div>
            ...
            <FadeIn delay={200}>
              <div className="space-y-6">
                ...
                <p className="text-white/80 text-lg leading-relaxed">
                  At Charged-Up Marketing, our mission is to fuel the growth of
                  SaaS companies with innovative, automated marketing solutions
                  that deliver real, measurable results. We harness the power of
                  AI technology and data-driven strategies to help you attract
                  high-quality leads, convert them into loyal customers, and
                  maximize your marketing ROI.
                </p>
                <p className="text-white/80 text-lg leading-relaxed">
                  We believe that your time is best spent building your product,
                  not chasing prospects or juggling campaigns. That&apos;s why
                  we create streamlined, scalable systems that work around the
                  clock — so your business runs at full power even when
                  you&apos;re off the clock. From startups looking to make their
                  mark to established brands aiming to dominate their market, we
                  provide the tools, strategies, and expertise to get you
                  charged up for success.
                </p>
                <div className="pt-4 flex gap-4">
                  <Link
                    href="/contact"
                    className="px-8 py-2.5 bg-[color:var(--brand-primary,#fc5f17)] hover:bg-[color:var(--brand-primary,#e55a15)] text-black rounded-lg transition-all duration-200 font-medium shadow-lg hover:shadow-xl hover:shadow-orange-500/25 transform hover:-translate-y-0.5 border-0"
                  >
                    Book a Strategy Call Today!
                  </Link>
                  <Link
                    href="/pricing"
                    className="px-8 py-2.5 bg-transparent border border-white/20 hover:bg-white/10 text-white rounded-lg transition-all duration-200 font-medium shadow-lg hover:shadow-xl hover:shadow-white/10 backdrop-blur-sm"
                  >
                    See Pricing
                  </Link>
                </div>
          ...
          <div className="text-center mb-12">
            <FadeIn delay={200}>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                How <span className="text-brand-accent">ColdDM AI</span> ⚡
                Works
              </h2>
              <p className="text-white/80 text-lg max-w-3xl mx-auto">
                Transform your customer service with AI that never sleeps.
                Automate responses, capture leads, and provide 24/7 support
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <FadeIn delay={300}>
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-6 text-center hover:border-orange-500/30 transition-all duration-300 group">
                ...
                <p className="text-white/70 text-sm">
                  Link your social media accounts in minutes. Works with
            ...
            <FadeIn delay={400}>
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-6 text-center hover:border-orange-500/30 transition-all duration-300 group">
                ...
                <p className="text-white/70 text-sm">
                  AI responds to customers 24/7, captures leads, and handles
                  common inquiries automatically.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={500}>
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-6 text-center hover:border-orange-500/30 transition-all duration-300 group">
                ...
                <p className="text-white/70 text-sm">
                  Grow your customer service without hiring more staff. Handle
