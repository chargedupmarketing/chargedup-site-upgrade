        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Choose the perfect plan for your business. From marketing services
              to AI-powered chatbots, we have solutions for every budget and
              need.
            </p>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto">
                Comprehensive digital marketing solutions including social media
                management, email marketing, and paid advertising to grow your
                business.
              </p>
            </div>
          ...
          <div id="colddm-pricing" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto">
                Automate customer service and capture leads 24/7 with
                intelligent AI chatbots that work across all your social media
                platforms.
              </p>
            </div>
          ...
          <div id="ai-pricing" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto">
                ...
                Get AI-enhanced insights, content generation, and strategic
                recommendations to transform your marketing.
              </p>
            </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-white/80 max-w-3xl mx-auto">
                Our AI platform delivers comprehensive marketing intelligence
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
                ...
                <p className="text-sm text-gray-400">
                  AI-powered marketing strategy and planning
                </p>
              </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-8 text-white/80">
                Choose the services that fit your business needs and start
                growing today.
              </p>
