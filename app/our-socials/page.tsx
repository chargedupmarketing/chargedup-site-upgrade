    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="h1 mb-6">
              Connect With <span className="text-[color:var(--brand-primary,#fc5f17)]">Us</span>
            </h1>
            <p className="p text-xl text-white/70 max-w-2xl mx-auto">
              Stay connected with Charged-Up Marketing across all our social platforms. 
              Get the latest marketing insights, tips, and updates from our team.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-blue-500/20 to-blue-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">LinkedIn Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Follow us on LinkedIn for professional insights, industry trends, and 
                  thought leadership content in the SaaS marketing space.
                </p>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-purple-500/20 to-purple-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">Twitter/X Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-orange-400 transition-colors">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Get real-time updates, marketing tips, and industry news on Twitter/X. 
                  Join the conversation and stay ahead of marketing trends.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-pink-500/20 to-pink-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">Instagram Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-orange-400 transition-colors">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Follow our visual journey on Instagram for behind-the-scenes content, 
                  team highlights, and creative marketing inspiration.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-red-500/20 to-red-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">YouTube Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-orange-400 transition-colors">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Subscribe to our YouTube channel for video tutorials, marketing tips, 
                  case studies, and expert insights from our team.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-indigo-500/20 to-indigo-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">Facebook Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-orange-400 transition-colors">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Like our Facebook page for community updates, marketing discussions, 
                  and to connect with other SaaS professionals and entrepreneurs.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-green-500/20 to-green-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">TikTok Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-orange-400 transition-colors">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Follow us on TikTok for quick marketing tips, trends, and creative 
                  content that helps SaaS companies stay ahead of the curve.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
        ...
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="h2 mb-6">
              Stay <span className="text-[color:var(--brand-primary,#fc5f17)]">Connected</span>
            </h2>
            <p className="p text-lg text-white/70 mb-8">
              Subscribe to our newsletter for exclusive marketing insights, industry updates, 
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="h2 mb-6">
              Ready to <span className="text-[color:var(--brand-primary,#fc5f17)]">Connect</span>?
            </h2>
            <p className="p text-lg text-white/70 mb-8">
              Follow us on social media and join our community of SaaS marketing professionals. 
              Let's grow together!
            </p>
