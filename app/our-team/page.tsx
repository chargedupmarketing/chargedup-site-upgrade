        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="h1 mb-6">
              Meet Our <span className="text-[color:var(--brand-primary,#fc5f17)]">Team</span>
            </h1>
            <p className="p text-xl text-white/70 max-w-2xl mx-auto">
              The passionate professionals behind Charged-Up Marketing. We're dedicated to helping 
              SaaS companies achieve remarkable growth through innovative marketing strategies.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="text-center group">
              ...
              <div className="w-64 h-64 mx-auto bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-3xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
                <div className="w-full h-full bg-gradient-to-br from-orange-500/20 to-orange-600/20 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-white/60 text-sm">Photo Coming Soon</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <p className="text-orange-400 font-semibold mb-4">Co-CEO / Co-Founder</p>
            <p className="text-white/70 text-lg leading-relaxed max-w-sm mx-auto">
              Dominic brings strategic vision and entrepreneurial expertise to Charged-Up Marketing. 
              With a passion for innovation and growth, he leads our mission to transform how 
              SaaS companies approach marketing.
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-orange-400 font-semibold mb-4">Co-CEO / Co-Founder</p>
            <p className="text-white/70 text-lg leading-relaxed max-w-sm mx-auto">
              Ty drives operational excellence and client success at Charged-Up Marketing. 
              His expertise in scaling businesses and building high-performing teams ensures 
              our clients receive world-class service and results.
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-orange-400 font-semibold mb-4">Head Of Accounting</p>
            <p className="text-white/70 text-lg leading-relaxed max-w-sm mx-auto">
              Ellouise ensures financial excellence and operational efficiency at Charged-Up Marketing. 
              Her meticulous attention to detail and financial expertise keeps our business 
              running smoothly while we focus on client success.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            <h2 className="h2 mb-6">
              Our <span className="text-[color:var(--brand-primary,#fc5f17)]">Values</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                We strive for excellence in every campaign, strategy, and client interaction.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                We embrace cutting-edge technology and creative solutions to drive results.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                We build lasting partnerships with our clients, working together for mutual success.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="h2 mb-6">
              Ready to Work with Our <span className="text-[color:var(--brand-primary,#fc5f17)]">Team</span>?
            </h2>
            <p className="p text-lg text-white/70 mb-8">
              Let's discuss how our team can help transform your SaaS company's marketing 
