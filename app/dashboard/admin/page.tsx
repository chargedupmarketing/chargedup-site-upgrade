...
import { Shield, Users, MessageSquare, Video, CreditCard, TrendingUp, Eye, Trash2, ToggleLeft, ToggleRight } from 'lucide-react'
...
export default function AdminPage() {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: 'John Doe', email: 'john@example.com', role: 'USER', credits: 15, status: 'active', lastActive: '2 hours ago' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'USER', credits: 8, status: 'active', lastActive: '1 day ago' },
    { id: 3, name: 'Bob Johnson', email: 'bob@example.com', role: 'USER', credits: 22, status: 'inactive', lastActive: '1 week ago' },
    { id: 4, name: 'Admin User', email: 'admin@chargedup.com', role: 'ADMIN', credits: 100, status: 'active', lastActive: 'Now' }
  ])
    ...
    <div className="flex-1 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-white mb-4">System Administration</h1>
          <p className="text-gray-400 text-lg">
            Manage users, monitor system performance, and control platform features
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700/50">
            <h3 className="text-lg font-semibold text-white mb-4">Feature Controls</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 font-medium">AI Chat</p>
                  <p className="text-gray-500 text-sm">Enable/disable AI chat functionality</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Enable/disable video generation</p>
                </div>
                <button className="w-12 h-6 bg-green-500 rounded-full relative">
                  <div className="w-4 h-4 bg-white rounded-full absolute right-1 top-1 transition-transform"></div>
                </button>
