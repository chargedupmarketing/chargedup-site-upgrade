...
import { Send, Plus, Trash2, MessageSquare, Loader2, Copy, Check, Search, ChevronDown } from 'lucide-react'
...
export default function AIChatPage() {
  ...
  const sendMessage = async (content: string) => {
    ...
    const updatedChat = {
      ...
      title: currentChat.messages.length === 0 ? content.trim().slice(0, 30) + '...' : currentChat.title,
      updatedAt: new Date()
    }
    ...
    try {
      ...
      if (error.message.includes('Rate limit exceeded')) {
        errorContent = 'OpenAI rate limit reached. This is a temporary restriction that usually resolves in 1-2 minutes. Please wait and try again.'
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Start a new conversation to begin</p>
          <button
    ...
    <div className="flex h-full">
      ...
      <div className="w-80 bg-gray-900/95 border-r border-gray-700/50 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4">
            <h3 className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wider">Chats</h3>
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border-b border-gray-700/50 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <h1 className="text-xl font-bold text-white">ChargedUp AI (Clarifai)</h1>
          ...
          {currentChat.messages.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-400">Your personalized AI assistant is ready to help!</p>
              </div>
            </div>
          ) : (
            <AnimatePresence>
            ...
            <div className="relative">
              ...
              {isRecording && (
                <div className="flex items-center justify-center mt-3 text-sm text-blue-400">
                  ...
                  <span>Voice recording in progress... Click the stop button to transcribe</span>
                </div>
              )}
              
              <p className="text-gray-500 text-xs mt-3 text-center">
                Powered by Clarifai GPT-OSS-120B • Your conversations are personalized and secure
              </p>
          </div>
        </div>
      </div>
