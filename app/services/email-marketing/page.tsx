        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="p text-xl text-white/70 max-w-2xl mx-auto">
              Convert leads into loyal customers with targeted, personalized
              email campaigns. We create compelling content and automated
              sequences that drive engagement and sales.
            </p>
        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Our comprehensive email marketing services deliver personalized
              campaigns that nurture relationships, drive conversions, and
              maximize your ROI through strategic automation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Design compelling email campaigns with engaging content,
                eye-catching visuals, and strategic messaging that resonates
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Build intelligent email workflows that automatically nurture
                leads, welcome new subscribers, and guide prospects through your
                conversion funnel.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Continuously test, analyze, and optimize your email campaigns
                for maximum open rates, click-through rates, and conversion
                performance.
              </p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              A systematic approach to email marketing that delivers measurable
              results and builds lasting relationships with your audience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                We analyze your audience, define campaign objectives, and create
                a strategic roadmap for your email marketing success.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Our team crafts compelling email content, designs eye-catching
                templates, and ensures your message resonates with your
                audience.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                We configure your email platform, set up automation sequences,
                and launch campaigns with proper testing and optimization.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Continuous monitoring, A/B testing, and performance optimization
                to improve results and maximize your email marketing ROI.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Discover how strategic email marketing transforms your customer
              relationships and drives revenue.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Deliver highly targeted content based on user behavior,
                    preferences, and demographics to increase engagement and
                    conversion rates.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Set up intelligent email sequences that automatically
                    nurture leads, welcome new subscribers, and guide prospects
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Track every aspect of your email performance with detailed
                    analytics, A/B testing, and conversion tracking for
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Comprehensive email marketing solutions covering every stage of
              the customer journey to maximize engagement and drive conversions.
            </p>
          </div>
        ...
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="p text-lg text-white/70 mb-8">
              Let&apos;s create email campaigns that nurture relationships,
              drive engagement, and convert your audience into loyal customers.
            </p>
