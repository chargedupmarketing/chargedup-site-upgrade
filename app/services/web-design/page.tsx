        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="p text-xl text-white/70 max-w-2xl mx-auto">
              Create stunning, high-converting websites that engage visitors and
              drive business growth. We design and develop custom websites that
              look amazing and perform even better.
            </p>
        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Our comprehensive web design and development services create
              digital experiences that captivate your audience and convert
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Unique, brand-focused designs that reflect your business
                identity and create memorable user experiences that set you
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Mobile-first development ensuring your website looks and
                functions perfectly across all devices, from smartphones to
                desktop computers.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Fast-loading websites with optimized code, images, and hosting
                to ensure excellent user experience and search engine rankings.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                ...
                requirements to create a comprehensive project plan and site
                architecture.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                ...
                identity and provide an intuitive user experience for your
                visitors.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Build your website using modern technologies, ensuring
                cross-browser compatibility and thorough testing across all
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Deploy your website with ongoing support, maintenance, and
                optimization to ensure continued performance and success.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Discover how professional web design transforms your online
              presence and drives business success.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    A professionally designed website builds trust and
                    credibility with your audience, making a strong first
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Intuitive navigation, fast loading times, and mobile
                    responsiveness create a seamless user experience that keeps
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Clean, semantic code and optimized content structure improve
                    your search engine rankings, making it easier for potential
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Strategic design elements, clear calls-to-action, and
                    optimized user flows guide visitors through your conversion
                    funnel, increasing sales and leads.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Comprehensive web design solutions for every business need, from
              simple landing pages to complex e-commerce platforms and custom
              web applications.
            </p>
          </div>
        ...
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="p text-lg text-white/70 mb-8">
              Let&apos;s create a stunning website that captivates your
              audience, drives conversions, and helps your business grow online.
            </p>
