        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="p text-xl text-white/70 max-w-2xl mx-auto">
              Transform your social media presence with data-driven insights and
              strategic planning. We analyze, optimize, and create winning
        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Our comprehensive social media audit and strategy services
              identify opportunities, optimize performance, and create
              actionable plans for sustainable growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Deep-dive analysis of your current social media performance,
                content quality, audience engagement, and competitive
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                Data-driven strategy development including content planning,
                posting schedules, platform-specific approaches, and growth
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70">
                ...
                engagement rates, and audience growth to maximize your social
                media ROI.
              </p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              A systematic approach to auditing and strategizing your social
              media presence that delivers measurable improvements and
              sustainable growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                We examine your current social media presence, analyze
                competitors, and identify key opportunities for improvement and
                growth.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Comprehensive report detailing current performance, strengths,
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Custom strategy creation including content themes, posting
                schedules, platform-specific tactics, and growth objectives.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-white/70 text-sm">
                Support with strategy implementation and ongoing monitoring to
                ensure continuous improvement and goal achievement.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Discover how our social media audit and strategy services
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    ...
                    audience insights, and performance metrics that reveal
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Understand your competitive landscape and identify unique
                    opportunities to differentiate your brand and capture market
                    share.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Optimize your content strategy to boost engagement rates,
                    build stronger relationships with your audience, and
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">
                    Track progress with clear KPIs and metrics that demonstrate
                    ROI, audience growth, and the impact of your social media
                    strategy.
                  </p>
                </div>
              </div>
      ...
      <div className="bg-gradient-to-br from-gray-900/50 to-black border-t border-white/10">
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="p text-lg text-white/70">
              Comprehensive analysis covering every aspect of your social media
              presence to identify opportunities for improvement and growth.
            </p>
          </div>
        ...
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="p text-lg text-white/70 mb-8">
              Let&apos;s analyze your current social media presence and create a
              winning strategy that drives engagement, builds your brand, and
              grows your audience.
            </p>
