    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Manage subscribers, create campaigns, and automate your email
          marketing
        </p>
      </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-white">
                {Math.round(
                  subscribers.reduce((acc, sub) => acc + sub.openRate, 0) /
                    subscribers.length
                )}
                %
              </p>
          ...
          {activeTab === 'automation' && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-6">
                Set up automated email sequences, welcome series, and
      ...
      {showNewSubscriberModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <p className="text-gray-400 mb-4">
              Subscriber form will be implemented here.
            </p>
            <button
