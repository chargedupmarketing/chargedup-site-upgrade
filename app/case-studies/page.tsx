        ...
        <div className="container py-20">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="h1 mb-6">
              What Our <span className="text-[color:var(--brand-primary,#fc5f17)]">Clients</span> Say
            </h1>
            <p className="p text-xl text-white/70 max-w-2xl mx-auto">
              Read what our clients have to say about working with Charged-Up Marketing. 
              We've helped SaaS companies transform their marketing and achieve remarkable growth.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              <div className="aspect-video bg-gradient-to-br from-orange-500/20 to-orange-600/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-sm">Case Study Coming Soon</div>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  We helped this innovative SaaS company transform their marketing strategy, 
                  resulting in significant growth and improved customer acquisition.
                </p>
          ...
          <div className="group">
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              ...
              <div className="p-6">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Discover how we implemented AI-powered marketing automation that increased 
                  lead generation by 300% while reducing manual workload.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
          ...
          <div className="group">
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              ...
              <div className="p-6">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Learn how our targeted email marketing strategy helped a B2B SaaS company 
                  achieve a 25% increase in customer retention and revenue growth.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
          ...
          <div className="group">
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              ...
              <div className="p-6">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  See how we completely transformed a company's social media presence, 
                  resulting in 150% increase in engagement and brand awareness.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
          ...
          <div className="group">
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
              ...
              <div className="p-6">
                ...
                <p className="text-white/70 mb-4 line-clamp-3">
                  Discover how our paid social media management increased conversion rates 
                  by 200% while reducing cost per acquisition by 40%.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-orange-400 text-sm font-medium">Coming Soon</span>
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-orange-500 transition-colors">
        ...
        <div className="container py-20">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="h2 mb-6">
              Ready to Become Our Next <span className="text-[color:var(--brand-primary,#fc5f17)]">Success Story</span>?
            </h2>
            <p className="p text-lg text-white/70 mb-8">
              Join the growing list of SaaS companies that have transformed their marketing 
              and achieved remarkable growth with Charged-Up Marketing.
            </p>
