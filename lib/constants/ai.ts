export const AI_CONFIG = {
  ...
  PLATFORM_DESCRIPTION: "Advanced AI-powered marketing intelligence and content generation platform",
...
export const ERROR_MESSAGES = {
  ...
  AUTHENTICATION_FAILED: 'Authentication error with AI services. Please try again.',
  RATE_LIMIT: 'Request limit reached. Please upgrade your plan for unlimited access.',
...
export const AI_CAPABILITIES = {
  MARKETING_STRATEGY: "AI-powered strategic marketing planning and optimization",
  ...
  COMPETITIVE_INTELLIGENCE: "AI-driven market research and competitive analysis",
