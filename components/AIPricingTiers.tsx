  ...
  const aiTiers = [
    {
      ...
      credits: 1000,
      description: 'Perfect for creating engaging content for Instagram, Twitter, Facebook, and more',
      features: [
    ...
    },
    {
      ...
      credits: 5500,
      description: 'Advanced AI tools for teams creating content across all major social platforms',
      features: [
    ...
    },
    {
      ...
      normalPrice: '',
      credits: 25000,
      description: 'Enterprise-grade AI solutions for agencies managing multiple brand accounts',
      features: [
          ...
          <div className={`enhanced-card p-8 h-full flex flex-col ${tier.popular ? 'ring-2 ring-purple-500' : ''}`}>
            ...
            <div className="text-center mb-6">
              ...
              <div className="mb-4">
                ...
                {tier.normalPrice && (
                  <p className="text-blue-400 text-sm font-medium mt-2">{tier.normalPrice}</p>
                )}
                
                {/* Credits Display */}
                <div className="mt-3 p-3 bg-gray-800/50 rounded-lg border border-gray-700/50">
                  <div className="text-center">
                    <span className="text-2xl font-bold text-blue-400">{tier.credits.toLocaleString()}</span>
                    <span className="text-white/80 text-sm ml-2">Credits</span>
                    <p className="text-white/60 text-xs mt-1">1 Credit = $0.01</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-auto">
              <a 
                href={tier.name === 'AI Enterprise' ? '/enterprise-inquiry' : '/contact'} 
              ...
              >
                {tier.name === 'AI Enterprise' ? 'Request Enterprise Quote' : 'Get Started'}
              </a>
            </div>
          </div>
        </div>
